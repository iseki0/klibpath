...
internal data object WindowsFileSystem : FileSystem {
    ...
    override fun openRead(path: Path): FileSource = WindowsFileSource(path.win.value)

    override fun openWrite(path: Path): FileSink =
    ...
    override fun openWrite(
        ...
        createNew: Boolean,
        truncate: Boolean,
    ): FileSink = WindowsFileSink(path.win.value, create, createNew, truncate)
